...
INSERT INTO cadry.employees (name_emp, gender_emp, birthday_emp, passport_emp, rnokpp_emp, address_emp, phone_emp, email_emp, job_title_emp, married_emp, child_emp, iban_emp, salary_emp, date_of_job_emp) 
VALUES 
